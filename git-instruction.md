...
Неоходимо зайти на Git hub . найти файл который нас интересует и нажать fork

Затем в VS нажать Clone Git Repository 

После редактирования файла нужно сохранить версию файла с изменениями 

После сохранения нужно написать команду git push -u origin master чтобы отправить сохранения на git hub 

На git hub выбераем pull requests 

Далее выбераем New pull requests . указываем изменения .а после нажимаем create pull requests 
